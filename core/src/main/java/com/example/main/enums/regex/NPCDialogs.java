...
public enum NPCDialogs {
    ...
    dialog4(null, 0, Weather.Stormy, "I hope the storm doesn't cause any damage."),
    dialog5(null, 0, Weather.Snowy, "The snow is beautiful, but it makes it hard to get around."),
    dialog6(Season.Spring, 0, null, "Spring is a time for new beginnings."),
    dialog7(Season.Summer, 0, null, "Summer is the best time for fishing."),
    ...
    dialog13(null, 1, Weather.Stormy, "The storm sometimes brings out the best in people."),
    dialog14(null, 1, Weather.Snowy, "I love the snow, it's so peaceful."),
    dialog15(Season.Spring, 1, null, "Spring is so beautiful around here."),
    dialog16(Season.Summer, 1, null, "Ah it's so hot around this time of the year."),
    dialog17(Season.Fall, 1, null, "The leaves are so colorful in the fall."),
    dialog18(Season.Winter, 1, null, "Winter is just snow and chill, ain't it?"),
    ...
    dialog22(null, 2, Weather.Stormy, "Stormy weather is perfect for cuddling up with a good book."),
    dialog23(null, 2, Weather.Snowy, "Snowy days are perfect for building snowmen."),
    dialog24(Season.Spring, 2, null, "Nice weather we're having, huh?"),
    ...
    dialog31(null, 3, Weather.Stormy, "Maybe we should stay at my place during the storm."),
    ...
    dialog35(Season.Fall, 3, null, "It's Fall again, don't you feel romantic?"),
    dialog36(Season.Winter, 3, null, "All you need is a warm blanket and a window during a snowy day.");
